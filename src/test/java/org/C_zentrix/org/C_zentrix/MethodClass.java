...
{
	static String s1,LicenseVersion,s3,s4,s5,zap_provider_name,campaign_id1,server_output,excel_user,campaign_user,campaign_state,sip_name,gateway_Interface,disposition_name,list_name;
    static int state, Feature_Details_agents,SIP_Extensions,agent_id,group_id,campaign_id,camp_count,agent_coun,list_count,sip_count,gateway_count,list_id;
  ...
  try{
		  ...
		  // Class.forName("oracle.jdbc.driver.oracleDriver");
	        ...
	        //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","himanshu","Himansu@123");
			 ...
			 String sql22="select max_value from maximum where maximum_id=5";
             String sql3="select list_id from list where list_name='User4_INBOUND'"; 
